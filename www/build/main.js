...
var ProductsPage = (function () {
    ...
    ProductsPage.prototype.getFilterdProducts = function () {
        ...
        var hello = this.http.get(this.config.url + '/api/appsettings/ionic_filter_products/?insecure=cool' + query).map(function (res) { return res.json(); }).subscribe(function (data) {
            if (data.data)
